...
hljs.registerLanguage("typescript", function (e) {
    var r = "[A-Za-z$_][0-9A-Za-z$_]*", t = {
        ...
        s = {cN: "params", b: /\(/, e: /\)/, eB: !0, eE: !0, k: t, c: [e.CLCM, e.CBCM, n, a]},
        c = {cN: "number", v: [{b: "\\b(0[bB][01]+)"}, {b: "\\b(0[oO][0-7]+)"}, {b: e.CNR}], r: 0},
    ...
    return o.c = [e.ASM, e.QSM, i, l, b, c, e.RM], {
        aliases: ["ts"],
        k: t,
        c: [{
            cN: "meta",
            b: /^\s*['"]use strict['"]/
        }, e.ASM, e.QSM, i, l, b, e.CLCM, e.CBCM, c, {
            b: "(" + e.RSR + "|\\b(case|return|throw)\\b)\\s*",
            k: "return throw case",
            c: [e.CLCM, e.CBCM, e.RM, {
                cN: "function",
